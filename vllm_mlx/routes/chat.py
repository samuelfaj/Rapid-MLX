...
_AGENTIC_REPAIR_USER_PROMPT = (
    ...
    "or services use ./routes or ./services. Do not put ../src or ./src in a "
    ...
    "for the requested service layer. If validation says a "
    ...
    "instance before tests run. Do not import production database singletons into "
